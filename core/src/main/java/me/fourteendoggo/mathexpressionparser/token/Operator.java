...
public enum Operator implements Token {
    ...
    LESS_THEN("<", 25, (a, b) -> boolToDouble(a < b)),
    GREATER_THEN(">", 25, (a, b) -> boolToDouble(a > b)),
    LESS_THEN_OR_EQUAL("<=", 25, (a, b) -> boolToDouble(a <= b)),
    GREATER_THEN_OR_EQUAL(">=", 25, (a, b) -> boolToDouble(a >= b)),
